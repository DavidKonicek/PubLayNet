...
call conda create --name %1 --yes python=%2 anaconda
...
@echo off
echo .
echo Creates new Conda environment for Python %2 with all Anaconda
echo standard packages. Creates minimal_requirements.txt from import
echo statements of *.py files.
echo .
echo Usage: %0 new-name-of-conda-environment version-of-python
echo .
exit /b
